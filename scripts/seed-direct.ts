...
async function seed() {
  try {
    ...
    await prisma.$transaction(async (tx) => {
      ...
      console.log('✅ Created 50 warehouses')
      ...
      console.log('✅ Created 50 suppliers')
      ...
      console.log('✅ Created 150 product batches')
      ...
      console.log('✅ Created 150 purchase orders')
      ...
      console.log('✅ Created 300 transactions')
    })
